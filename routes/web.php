...
Route::get('/admin_login', [AdminDashboardController::class, 'login']);

Route::get('/admin_logout',[AdminDashboardController::class, 'admin_logout'])->name('admin_logout');




Route::group(['middleware'=>['AuthCheck']], function(){
	Route::post('/admin_login', [AdminDashboardController::class, 'auth_check'])->name('admin.check');
...
//to set 'dashboard' in url
	...
	// Start admin -----------------------------
		Route::get('/add_new_admin', [AdminDashboardController::class, 'add_admin'])->name('add_new_admin.page');
		Route::post('/add_new_admin', [AdminDashboardController::class, 'save_admin'])->name('admin.save');
		Route::get('/all_admins', [AdminDashboardController::class, 'all_admins'])->name('all_admins.view');

		// to set 'profile' in url after 'dashboard'
		Route::group(['prefix' => 'profile'], function(){
			Route::get('/admin_profile', [AdminDashboardController::class, 'admin_profile'])->name('admin.profile');
		// profile password change page
		Route::get('/change_password', [AdminDashboardController::class, 'show_password'])->name('password.show');
	
		// change the password
		Route::post('/change_password', [AdminDashboardController::class, 'change_password'])->name('password.change');
...
// ====================== for all products =========================
	Route::group(['prefix' => 'product'], function(){
		...
		Route::group(['prefix' => 'mobile'], function(){
			...
			Route::get('/add_new_product', [MobileController::class, 'add_mobile'])->name('mobile.add');
			// add new mobile post
			Route::post('/add_new_product', [MobileController::class, 'add_mobile_post'])->name('mobilepost.add');
			// View single post 
		...
		Route::group(['prefix' => 'camera'], function(){
			...
			Route::get('/add_new_product', [CameraController::class, 'add_camera'])->name('camera.add');
			Route::post('/add_new_product', [CameraController::class, 'add_new_camera'])->name('newcamera.add');
		...
		Route::group(['prefix' => 'laptop'], function(){
			...
			Route::get('/add_new_product', [LaptopController::class, 'add_laptop'])->name('laptop.add');
		...
		Route::group(['prefix' => 'smartwatch'], function(){
			...
			Route::get('/add_new_product', [SmartwatchController::class, 'add_smartwatch'])->name('smartwatch.add');
		...
		Route::group(['prefix' => 'tablet'], function(){
			...
			Route::get('/add_new_product', [TabletController::class, 'add_tablet'])->name('tablet.add');
